    ...
    return (
        <>
            <div className="py-2 w-full flex flex-row gap-4 items-start">
                <div className="w-3/5 border-black/10 border bg-white rounded-xl shadow-md p-6 flex flex-col min-h-[180px] h-auto max-h-96 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full">
                ...
                <div className="w-2/5 border-black/10 border bg-white rounded-xl shadow-md p-6 flex flex-col min-h-[180px] h-auto max-h-96 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full">
